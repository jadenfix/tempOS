...
Usage:
    ...
    python tools/final_integrity.py --update   # re-pin after an intentional, additive edit
"""
...
LOCK_FILE = Path(__file__).resolve().parent / "final_integrity.lock.json"
...
def check() -> int:
    ...
    if problems:
        ...
        print(
            ...
            "    python tools/final_integrity.py --update",
            file=sys.stderr,
        )
        return 1
